...
**Mi a szónoki beszéd szerkezete?**  
A szónoki beszéd szerkezete egy világos, logikus felépítést követ, amely segíti a hallgatókat a téma megértésében és a beszélő álláspontjának elfogadásában. A beszéd tipikus részei: bevezetés, elbeszélés, kitérés, témamegjelölés, bizonyítás, cáfolás és befejezés.

#### Bevezetés fajtái:

- **Előadásra készülő beszéd**: A szónok azonnali kapcsolatba lép a közönséggel, hogy megragadja a figyelmüket.
    - **Megszólítás**: A hallgatóság megszólítása, figyelemfelkeltés.
    - **Átvezetés**: A téma bevezetése, ami segít a közönséget a beszéd fő részére hangolni.
- **Írott szöveg esetén**: Az írott beszéd egy strukturált bevezetőt igényel, hogy a téma világosan legyen felvezetve.
    - **Cím**: A beszéd vagy írás fő gondolata, amely az olvasót vagy hallgatót irányítja.
    - **Átvezetés**: A téma és célok bemutatása, segítve az olvasót a következő szakaszra való áttérésben.

#### Elbeszélés:

- **Tényfeltárás**: A beszéd elsődleges célja az, hogy világos képet adjon a helyzetről, bemutatva a szükséges hátteret.
    - **Előzmények, kutatások**: A téma kontextusának bemutatása, előzményeinek ismertetése.
    - **Fogalmak**: Kulcsfogalmak tisztázása, amelyek a téma megértéséhez szükségesek.

#### Kitérés:

- A beszédben előfordulhat, hogy a szónok elágazik vagy elkalandozik egy kiegészítő, de fontos pont felé, mielőtt visszatér a fő témához.

#### Témamegjelölés:

- **Álláspont kimondása**: A szónok világosan kijelenti a beszéd központi üzenetét, azaz mit kíván elérni.
- **Bizonyítás előkészítése**: A szónok felvázolja azokat a logikai alapokat és érveket, amelyekkel alátámasztja a mondanivalóját.

#### Bizonyítás:

- **Cél**: A szónok célja mások meggyőzése, és a téma körüljárása.
- **Fajtái**:
    - **Jelek**: Külső, megfigyelhető tényezők, amelyek alátámasztják a beszédet.
    - **Érvek**: A meggyőzés érdekében használt logikai, filozófiai vagy gyakorlati állítások.
        - **Indukció**: Az általánosításhoz vezető érvelés, ahol a konkrét esetekből általános következtetéseket vonunk le.
        - **Dedukció**: A logikai érvelés egy magasabb szintű elvről, amelyből egy konkrét állítást vezetünk le.
    - **Példák**: Konkrét esetek bemutatása, amelyek alátámasztják az érvet.

#### Cáfolás:

- A beszéd része, amely akkor szükséges, ha a közönség, vagy egy ellenfél ellenvéleménnyel rendelkezik. A szónok megpróbálja megcáfolni a felmerült ellenérveket, ezzel is erősítve saját álláspontját.
